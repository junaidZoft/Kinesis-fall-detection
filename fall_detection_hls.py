...
st.set_page_config(page_title="Fall Detection Stream (HLS)", layout="wide")
st.title("Real-time Fall Detection (YOLO) — HLS Stream from Kinesis")
...
with col2:
    ...
    try:
        ...
        st.success(f"HLS URL obtained from Kinesis.")
